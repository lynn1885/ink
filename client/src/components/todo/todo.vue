...
#todo-results {
  ...
  overflow-y: scroll;
  .item.active {
    background: $sidebar-item-error-bg !important;
  }
  .item {
    font-size: $font-size-sidebar;
    padding: 6px 8px;
    margin-bottom: 6px;
    background: lighten($color: $sidebar-item-error-bg, $amount: 3);
    line-height: $sidebar-line-height;
    box-sizing: border-box;
    /* box-shadow: 0px 0px 2px 0px darken($color: $sidebar-item-error-bg, $amount: 4); */
    cursor: pointer;
    .header {
      color: $comment-color;
      overflow: hidden;
    ...
    &:hover {
      background: $sidebar-item-error-bg;
    }
    &:last-of-type {
      margin-bottom: 120px;
    }
