# 重要说明
* 这是开发者利用闲余时间制作的个人笔记本工具, 当前还处于alpha阶段, 且不保证继续维护
* 正式版发布时, 项目架构还会有很大的变动
* 项目中存在大量bug和待优化项, 且尚未编写测试用例和开发者文档
* 不过事实上该应用已经基础可用了, 开发者个人已经使用该工具将近两年时间, 记录了逾百万字笔记了. 如果您是尝鲜者, 或者真的需要这种形式的工具, 可以选择尝试一下, 但要做好面对各种小bug的心理准备.
